...
if ( ! function_exists('link_to'))
{
    ...
    {
        return app('flash')->link($url, $title, $attributes, $secure);
    }
}
...
if ( ! function_exists('link_to_asset'))
{
    ...
    {
        return app('flash')->linkAsset($url, $title, $attributes, $secure);
    }
}
...
if ( ! function_exists('link_to_route'))
{
    ...
    {
        return app('flash')->linkRoute($name, $title, $parameters, $attributes);
    }
}
...
if ( ! function_exists('link_to_action'))
{
    ...
    {
        return app('flash')->linkAction($action, $title, $parameters, $attributes);
    }
}
